...
public class MySchedLastWeek extends AppCompatActivity {
    ...
    public void createNavigationBar(){
        ...
        if(manager>0) {
            ...
            setSched.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(MySchedLastWeek.this, ManagerSetSched.class);
                    startActivity(intent);
                }
            });
        }
        ...
        if (branch.getSchedReady()) {
            ...
            nextWeek.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MySchedLastWeek.this, MySchedNextWeek.class);
                    startActivity(intent);
                }
            });
        } else {
            fillMySched.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MySchedLastWeek.this, FillPossibleShifts.class);
                    startActivity(intent);
                }
            });
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.logout:
                ...
                intent = new Intent(MySchedLastWeek.this, Login.class);
                startActivity(intent);
        }
